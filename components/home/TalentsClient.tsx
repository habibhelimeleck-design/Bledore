...
───────────────────────────────────────────── */
function TalentCard({ talent, index }: { talent: TalentCardData; index: number }) {
  ...
  return (
    ...
    >
      <motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }}>
        ...
        >
          {/* ── Image ── */}
          <div className="relative aspect-[3/4] overflow-hidden bg-[#071a10]">
            {talent.image ? (
              <Image
                src={talent.image}
              ...
              /* Placeholder pour les talents sans photo */
              <div
                className="absolute inset-0 flex items-center justify-center"
                style={{ background: "linear-gradient(135deg, #071a10 0%, #0d2d1a 100%)" }}
              >
                <span
                  className="font-heading text-[4rem] font-600 leading-none"
                  style={{ color: "rgba(38,208,124,0.18)" }}
                >
